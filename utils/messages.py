...
beginner = {
    'INTRO': """Hi, {username}! Welcome to Shinobi of the Lotus. I\'m 
    Cephalon Seren, a moderator bot in this server. 
    ...
    'OPTION_1_RESPONSE': """Thanks for letting me know! I\'ll let an
    admin know and they\'ll be with you soon.""",
    'OPTION_2_RESPONSE': """Great! In the server, you\'ll find the 
    {billboards} channel. Look through the list and see which ones 
    you may be interested in. If you\'d like, you can even 
    create your own!""",
